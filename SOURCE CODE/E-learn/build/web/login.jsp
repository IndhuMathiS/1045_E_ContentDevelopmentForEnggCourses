...
<FORM name=xyz action="UserValid.jsp" method="post">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
                ...
                <h2 class="text-center form-signin-heading">New user?</h2>

                <a class="btn btn-lg btn-warning btn-block" href="register.jsp">REGISTER HERE</a>
                ...
                <p> 
                    <INPUT type=hidden value=/members+only/legislative/gr_acct_menu.htm name=url>
                    <INPUT type=hidden value=/members+only/legislative/gr_acct_menu.htm name=ReqURL>
                </p>
</FORM>
